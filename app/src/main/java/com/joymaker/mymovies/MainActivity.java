...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerViewSmallPosters = findViewById(R.id.recyckerViewSmallPosters);
        switchSort = findViewById(R.id.switchSort);
        textViewPopularity = findViewById(R.id.textViewPopularity);
        textViewTopRated = findViewById(R.id.textViewTopRated);
        recyclerViewSmallPosters.setLayoutManager(new GridLayoutManager(this, getColumnCount()));
    ...
    public void onClickSwitchPopularity(View view) {
        setMethodOfSort(false);
        switchSort.setChecked(false);
    }

    public void onClickSwitchTopRated(View view) {
    ...
    private void setMethodOfSort(boolean isTopRated) {
        if (isTopRated) {
            ...
            textViewPopularity.setTextColor(Color.WHITE);
